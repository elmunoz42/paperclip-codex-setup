# Copy-paste handoff to Chief of Staff

Use the following as a task message when Carlos chooses to route it. It has not been sent or installed.

---

Our primary audience is ML-oriented developers who want mathematics and code. Read `recommendations/README.md`, both topic recommendations, `recommendations/perseverance-notebook-spec.md`, and `agent-os/specs/2026-09-05-technical-lessons/tasks.md` in this repository.
...
Return artifact links and task evidence. Do not publish, spend, change infrastructure, or install proposed system prompt changes. Carlos retains final editorial approval. The adviser provides GitHub recommendations; your team implements and reports evidence.
